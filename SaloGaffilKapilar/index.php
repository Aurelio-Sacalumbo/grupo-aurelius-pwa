...
<div class="painel-azul" id="dadosAgendamento" style="margin-top: 25px;">
    ...
    <div id="secao-home" class="aba-conteudo active">
        ...
        <div style="background: linear-gradient(135deg, #1e40af, #10b981); border-radius: 15px; padding: 25px; text-align: center; margin-bottom: 25px; border: 1px solid #3b82f6; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.3);">
...
<!-- =================================================================
     ...
     <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 15px; margin-bottom: 25px;">
         ...
         <div class="passo-card-neon" style="animation-delay: 1.2s; border-bottom: 2px solid #34d399 !important;">
             <div class="emoji-glow">🎁</div>
             <h4 style="color: #34d399;">6. Cupões de Popularidade</h4>
...
echo "<p style='color:#34d399; background:#111e36; padding:10px; text-align:center;'>O ID da barbearia ativa na sessão é: " . $_SESSION['empresa_codigo'] . "</p>";
        ...
        <?php if ($query_produtos && $query_produtos->num_rows > 0): ?>
            ...
            ?>
                <div class="passo-card" style="text-align: center;">
                    ...
                    <p style="font-size: 20px; font-weight: bold; color: #34d399; margin-bottom: 4px;">
